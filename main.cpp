//g++ main.cpp -o main -L. -lcurl 
#include "head.h"
#include "hole_searcher.cpp"
#include "holecollection.h"

using std::cin;
using std::cout;

inline void test_holecollection() {
...
int main() {
	...
	// cout << x.to_str() << '\n';
	// Filter AFilter(Filter::KeywordFilterType::And, new KeywordFilter("出", 1),new KeywordFilter("山地车", 1));
	// hole search for AFilter and T_ALLOK
